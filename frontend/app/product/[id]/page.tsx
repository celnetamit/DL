...
export default function ProductDetailPage() {
  ...
  // totalCount for this specific page
  const pageCount = modules.reduce((sum, m) => sum + m.contents.length, 0);
